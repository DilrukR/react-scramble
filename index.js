...
var TextScramble = function TextScramble(_ref) {
  var _ref$texts = _ref.texts,
    texts = _ref$texts === void 0 ? ["Hello world from React Scrumble "] : _ref$texts,
    ...
    nextLetterSpeed = _ref$nextLetterSpeed === void 0 ? 100 : _ref$nextLetterSpeed,
    ...
    scrambledColor = _ref$scrambledColor === void 0 ? "gray" : _ref$scrambledColor,
    _ref$revealedColor = _ref.revealedColor,
    revealedColor = _ref$revealedColor === void 0 ? "black" : _ref$revealedColor,
    onAnimationEnd = _ref.onAnimationEnd,
    onTextScrambleComplete = _ref.onTextScrambleComplete,
    _ref$symbols = _ref.symbols,
    symbols = _ref$symbols === void 0 ? "ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("") : _ref$symbols;
      ...
      if (!paused) {
        ...
        currentText.split("").forEach(function (_, i) {
          if (!leftIndexes.includes(i)) {
            updatedText[i] = /*#__PURE__*/_react["default"].createElement("span", {
              key: i,
              style: {
                color: revealedColor
              },
